...
function App() {
  ...
  const claimNFTs = async () => {
    ...
    let freeQuantity = await blockchain.smartContract.methods.freeQuantity().call();
    if (Supply >= freeQuantity) {
      cost = await blockchain.smartContract.methods.publicCost().call();
    } else {
      cost = 0
    }
